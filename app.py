...
if analyze_btn:
    ...
    with tabs[3]:
        ...
        if "허" in f_info['indication_traditional'] or "보" in f_info['pattern_tags']:
            ...
            st.markdown("- 선택 처방의 주증상에 따른 맥/설 대조 필요")
    ...
    with tabs[7]:
        ...
        if is_level_3:
            st.success(f"{selected_formula}의 기하학적 평형 방향성 시각화가 완료되었습니다. 상세 논문 데이터 참조.")
        else:
            st.warning("이 처방의 다면체 동적 평형 매핑은 데이터 수집 중입니다. (Level 1/2 임상 정보 우선 제공)")
