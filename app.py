...
MERGED_SOURCE_NOTE = (
    ...
    "텐세그리티 역학 화면을 한의학용 기하학 구조 도구로 재구성한 단일 파일 빌드입니다."
)
...
(
    ...
    candidate_tab, report_tab, protocol_tab, literature_tab, tensegrity_tab, integration_tab,
) = st.tabs(
    [
        "1. 한의학 구조 홈",
        "2. 오행 정오각형",
...
with integration_tab:
    ...
    st.caption(f"새 텐세그리티 원본 SHA-256: {NEW_TENSEGRITY_SOURCE_SHA256}")
    ...
    st.download_button(
        ...
        file_name="tcm_geometry_v6_merge_manifest.json",
        mime="application/json",
...
st.divider()
st.caption("한의학용 기하학 보조도구 v6.0: 한의학 자료와 황금비 다면체·정사영·위상 벡터를 구조화·배치·비교·검증합니다. 진단·처방·용량·침구 시술을 자동 결정하지 않습니다.")
